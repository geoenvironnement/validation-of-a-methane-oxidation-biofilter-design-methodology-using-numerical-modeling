...
dfLower = dfLower[['1', '3', '8', '10', '15']]
dfMedian = dfMedian[['1', '3', '8', '10', '15']]
dfUpper = dfUpper[['1', '3', '8', '10', '15']]
...
yLabel = ['1', '3', '8', '10', '15', '1', '3', '8', '10', '15', '1', '3', '8', '10', '15']
...
hmap.set(xlabel='Julian Day (2021)', ylabel="Lower                 Mean                Upper\nWRC                  WRC                WRC\nInstrumentation Points")
hmap.invert_yaxis()
...
plt.savefig('../2.Figures/F11a_Heatmap_95.png', bbox_inches='tight', dpi=600)
plt.show()